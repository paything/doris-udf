...
select '2024-01-01 00:00:00.000' as dt,'user1' as uid,'reg' as event,'te@st1' as group0
union all
select '2024-01-01 00:00:00.000' as dt,'user1' as uid,'iap' as event,'te#st2' as group0
union all
select '2024-01-01 00:00:00.000' as dt,'user1' as uid,'chat' as event,'te,st3' as group0
)
SELECT 
