        ...
        if ("band" === attribute.type) {
            attribute.domain.forEach((text => {
                ...
                const {width: width, height: height} = table.measureText(text, {
                    fontSize: null !== (_c = null === (_b = null === (_a = attribute.label) || void 0 === _a ? void 0 : _a.style) || void 0 === _b ? void 0 : _b.fontSize) && void 0 !== _c ? _c : DEFAULT_TEXT_FONT_SIZE,
                    ...
                    fontFamily: null !== (_j = null === (_h = null === (_g = attribute.label) || void 0 === _g ? void 0 : _g.style) || void 0 === _h ? void 0 : _h.fontFamily) && void 0 !== _j ? _j : DEFAULT_TEXT_FONT_FAMILY
            ...
            let ticks;
            if ((null === (_b = config.sync) || void 0 === _b ? void 0 : _b.tickAlign) && isFunction(null === (_c = config.tick) || void 0 === _c ? void 0 : _c.tickMode)) ticks = config.tick.tickMode(); else if (isArray(config.__ticksForVTable)) ticks = config.__ticksForVTable; else {
