...
export function bindTouchListener(eventManager) {
    ...
    const globalTouchMoveCallback = e => {
        ...
        (null === (_b = null === (_a = eventManager.downIcon) || void 0 === _a ? void 0 : _a.attribute) || void 0 === _b ? void 0 : _b.funcType) === IconFuncTypeEnum.dragReorder) e.preventDefault(); else if (eventManager.touchMovePoints.length > 4 && eventManager.touchMovePoints.shift(), 
        eventManager.touchMovePoints.push({
    ...
    const globalTouchEndCallback = e => {
        ...
        if (eventManager.touchEnd = !0, eventManager.isLongTouch = !1, eventManager.isTouchdown && isTouchEvent(e)) {
            if ((null === (_b = null === (_a = eventManager.downIcon) || void 0 === _a ? void 0 : _a.attribute) || void 0 === _b ? void 0 : _b.funcType) === IconFuncTypeEnum.dragReorder) e.preventDefault(); else if ((null === (_c = eventManager.touchMovePoints) || void 0 === _c ? void 0 : _c.length) && (eventManager.touchMovePoints.length > 4 && eventManager.touchMovePoints.shift(), 
            eventManager.touchMovePoints.push({
                x: table.rotateDegree ? e.changedTouches[0]._canvasX : e.changedTouches[0].pageX,
                y: table.rotateDegree ? e.changedTouches[0]._canvasY : e.changedTouches[0].pageY,
                timestamp: Date.now()
