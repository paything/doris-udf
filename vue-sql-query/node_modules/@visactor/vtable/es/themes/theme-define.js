...
import { DEFAULTBGCOLOR, DEFAULTBORDERCOLOR, DEFAULTBORDERLINEDASH, DEFAULTBORDERLINEWIDTH, DEFAULTFONTCOLOR, DEFAULTFONTFAMILY, DEFAULTFONTSIZE } from "../tools/global";

import { defalutPoptipStyle, getAxisStyle } from "./component";

function getProp(obj, superObj, names, defNames) {
    var _a, _b, _c;
    return null !== (_c = null !== (_b = null !== (_a = getChainSafe(obj, ...names)) && void 0 !== _a ? _a : getChainSafe(superObj, ...names)) && void 0 !== _b ? _b : defNames && getChainSafe(obj, ...defNames)) && void 0 !== _c ? _c : defNames && getChainSafe(superObj, ...defNames);
}
...
export class TableTheme {
    ...
    get rowHeaderStyle() {
        var _a;
        if (!this._rowHeader) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, header = ingoreNoneValueMerge({}, this.defaultStyle, superTheme.rowHeaderStyle, null !== (_a = obj.rowHeaderStyle) && void 0 !== _a ? _a : this.isPivot ? null : obj.headerStyle);
    ...
    get axisStyle() {
        if (!this._axisStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, axisStyle = ingoreNoneValueMerge({}, superTheme.axisStyle, obj.axisStyle);
    ...
    get checkboxStyle() {
        if (!this._checkboxStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, checkboxStyle = ingoreNoneValueMerge({}, superTheme.checkboxStyle, obj.checkboxStyle);
    ...
    get radioStyle() {
        if (!this._radioStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, radioStyle = ingoreNoneValueMerge({}, superTheme.radioStyle, obj.radioStyle);
    ...
    get switchStyle() {
        if (!this._switchStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, switchStyle = ingoreNoneValueMerge({}, superTheme.switchStyle, obj.switchStyle);
    ...
    get buttonStyle() {
        if (!this._buttonStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, buttonStyle = ingoreNoneValueMerge({}, superTheme.buttonStyle, obj.buttonStyle);
    ...
    get textPopTipStyle() {
        if (!this._textPopTipStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, textPopTipStyle = ingoreNoneValueMerge({}, defalutPoptipStyle, superTheme.textPopTipStyle, obj.textPopTipStyle);
    ...
    get functionalIconsStyle() {
        if (!this._internalIconsStyle) {
            const {obj: obj, superTheme: superTheme} = this.internalTheme, functionalIconsStyle = ingoreNoneValueMerge({}, superTheme.functionalIconsStyle, obj.functionalIconsStyle);
