...
export class SceneProxy {
        ...
        return __awaiter(this, void 0, void 0, (function*() {
            if (!this.isProgressing) return this.isProgressing = !0, new Promise(((resolve, reject) => {
                setTimeout((() => __awaiter(this, void 0, void 0, (function*() {
                    ...
                    yield this.progress()), handleTextStick(this.table), this.table.scenegraph.updateNextFrame(), 
                    resolve());
                }))), 16);
            }));
        }));
    ...
    createRowCellGroup(onceCount) {
        ...
        if ("adaptive" !== this.table.heightMode && computeRowsHeight(this.table, this.currentRow + 1, endRow, !1), 
        ...
        for (let col = this.bodyLeftCol; col <= this.bodyRightCol; col++) {
            ...
            const {height: height} = createComplexColumn(colGroup, col, colGroup.attribute.width, this.currentRow + 1, endRow, this.table.scenegraph.mergeMap, this.table.defaultRowHeight, this.table);
    ...
    createColGroup(onceCount) {
        ...
        "adaptive" !== this.table.widthMode && computeColsWidth(this.table, this.currentCol + 1, endCol), 
        this.colEnd = endCol;
        for (let row = 0; row < this.table.rowCount; row++) {
            const cellGroup = this.highPerformanceGetCell(this.currentCol, row);
            "cell" === cellGroup.role && isNumber(cellGroup.mergeStartCol) && cellGroup.mergeStartCol > this.currentCol && this.table.scenegraph.updateCellContent(cellGroup.col, cellGroup.row);
        }
    ...
    updateCellGroups(count) {
        ...
        this.table.isAutoRowHeight(this.rowUpdatePos) && computeRowsHeight(this.table, this.rowUpdatePos, distRow, !1), 
        updateRowContent(this.rowUpdatePos, distRow, this), this.table.isAutoRowHeight(this.rowUpdatePos) && (updateAutoRow(this.bodyLeftCol, this.bodyRightCol, this.rowUpdatePos, distRow, this.table, this.rowUpdateDirection, !0), 
        updateAutoRow(0, this.table.frozenColCount - 1, this.rowUpdatePos, distRow, this.table, this.rowUpdateDirection, !0), 
        updateAutoRow(this.table.colCount - this.table.rightFrozenColCount, this.table.colCount - 1, this.rowUpdatePos, distRow, this.table, this.rowUpdateDirection, !0)), 
    ...
    updateBottomFrozenCellGroups() {
        ...
        this.table.isAutoRowHeight(startRow) && computeRowsHeight(this.table, startRow, endRow, !1), 
        updateRowContent(startRow, endRow, this), this.table.isAutoRowHeight(startRow) && (updateAutoRow(this.bodyLeftCol, this.bodyRightCol, startRow, endRow, this.table, this.rowUpdateDirection), 
    ...
    updateRightFrozenCellGroups() {
        ...
        "autoWidth" === this.table.widthMode && computeColsWidth(this.table, startCol, endCol, !1), 
        updateColContent(startCol, endCol, this), this.table.isAutoRowHeight(this.rowStart) && updateAutoColumn(startCol, endCol, this.table, this.colUpdateDirection);
    }
    ...
    updateColGroups(count) {
        ...
        "autoWidth" === this.table.widthMode && computeColsWidth(this.table, this.colUpdatePos, distCol), 
        updateColContent(this.colUpdatePos, distCol, this), this.colUpdatePos = distCol + 1;
    }
