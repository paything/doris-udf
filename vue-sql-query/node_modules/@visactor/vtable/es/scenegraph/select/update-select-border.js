...
export function updateAllSelectComponent(scene) {
...
export function updateCellSelectBorder(scene, selectRange, ifExtendSelectRange = !0) {
...
export function hideCellSelectBorder(scene) {
    scene.selectingRangeComponents.forEach(((selectComp, key) => {
...
export function restoreCellSelectBorder(scene) {
    scene.selectingRangeComponents.forEach(((selectComp, key) => {
