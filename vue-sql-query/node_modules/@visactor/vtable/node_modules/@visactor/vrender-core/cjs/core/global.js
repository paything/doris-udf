...
const inversify_lite_1 = require("../common/inversify-lite"), contribution_provider_1 = require("../common/contribution-provider"), tapable_1 = require("../tapable"), constants_1 = require("../constants"), generator_1 = require("../common/generator"), event_listener_manager_1 = require("../common/event-listener-manager"), defaultEnv = "browser";
...
let DefaultGlobal = class extends event_listener_manager_1.EventListenerManager {
    ...
    constructor(contributions) {
        ...
        this.id = generator_1.Generator.GenAutoIncrementId(), this.hooks = {
