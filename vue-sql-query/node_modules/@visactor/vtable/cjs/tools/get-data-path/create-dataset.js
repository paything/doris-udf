...
function createDataset(options) {
    ...
    options.columnTree && (!1 !== options.indicatorsAsCol && (columnTree = (0, layout_helper_1.supplementIndicatorNodesForCustomTree)(options.columnTree, options.indicators)), 
    columnDimensionTree = new tree_helper_1.DimensionTree(null !== (_a = options.columnTree) && void 0 !== _a ? _a : [], layoutNodeId)), 
    options.rowTree && (!1 === options.indicatorsAsCol && (rowTree = (0, layout_helper_1.supplementIndicatorNodesForCustomTree)(options.rowTree, options.indicators)), 
    ...
    return {
        dataset: new dataset_1.Dataset(dataConfig, rowKeys, columnKeys, indicatorKeys, options.indicators, null === (_l = options.indicatorsAsCol) || void 0 === _l || _l, options.records, void 0, void 0, columnTree || options.columnTree, rowTree || options.rowTree, !0),
