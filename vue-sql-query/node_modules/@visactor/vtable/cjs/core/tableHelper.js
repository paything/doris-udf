...
function _setRecords(table, records = []) {
    _dealWithUpdateDataSource(table, (() => {
        ...
        const newDataSource = table.internalProps.dataSource = data_1.CachedDataSource.ofArray(records, table.internalProps.dataConfig, table.pagination, table.internalProps.columns, table.internalProps.layoutMap.rowHierarchyType, getHierarchyExpandLevel(table));
...
function _getScrollableVisibleRect(table) {
    ...
    new Rect_1.Rect(table.scrollLeft + frozenColsWidth, table.scrollTop + frozenRowsHeight, table.tableNoFrameWidth - frozenColsWidth - rightFrozenColsWidth, table.tableNoFrameHeight - frozenRowsHeight - bottomFrozenRowsHeight);
}
