...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getAxisAttributes = exports.getCommonAxis = exports.commonAxis = exports.THEME_CONSTANTS = exports.DEFAULT_TEXT_FONT_SIZE = exports.DEFAULT_TEXT_FONT_FAMILY = void 0;
...
function getCommonAxis(theme) {
    var _a, _b;
    return (null === (_b = null === (_a = null == theme ? void 0 : theme.colorScheme) || void 0 === _a ? void 0 : _a.default) || void 0 === _b ? void 0 : _b.palette) ? (0, 
    vutils_1.merge)({}, exports.commonAxis, {
        tick: {
            style: {
...
function getAxisAttributes(option) {
    ...
    "left" !== spec.orient && "right" !== spec.orient || (null === (_c = spec.title) || void 0 === _c ? void 0 : _c.autoRotate) && (0, 
    ...
    return {
        ...
        tick: {
            ...
            style: (0, transform_1.transformToGraphic)(spec.tick.style),
            state: (0, transform_1.transformStateStyle)(spec.tick.state),
        ...
        subTick: {
            ...
            style: (0, transform_1.transformToGraphic)(spec.subTick.style),
            state: (0, transform_1.transformStateStyle)(spec.subTick.state)
        },
        grid: {
            type: "line",
            ...
            style: (0, transform_1.transformToGraphic)(spec.grid.style)
        },
        subGrid: {
            type: "line",
            visible: spec.subGrid.visible,
            alternateColor: spec.subGrid.alternateColor,
            style: (0, transform_1.transformToGraphic)(spec.subGrid.style)
        },
        title: {
            ...
            textStyle: (0, vutils_1.merge)({}, titleTextStyle, (0, transform_1.transformToGraphic)(spec.title.style)),
            ...
            shape: {
                ...
                style: (0, transform_1.transformToGraphic)(null === (_f = spec.title.shape) || void 0 === _f ? void 0 : _f.style)
            },
            background: {
                visible: null === (_g = spec.title.background) || void 0 === _g ? void 0 : _g.visible,
                style: (0, transform_1.transformToGraphic)(null === (_h = spec.title.background) || void 0 === _h ? void 0 : _h.style)
            },
            state: {
                text: (0, transform_1.transformStateStyle)(spec.title.state),
                shape: (0, transform_1.transformStateStyle)(null === (_j = spec.title.shape) || void 0 === _j ? void 0 : _j.state),
                background: (0, transform_1.transformStateStyle)(null === (_k = spec.title.background) || void 0 === _k ? void 0 : _k.state)
            }
        },
        panel: {
            visible: null === (_l = spec.background) || void 0 === _l ? void 0 : _l.visible,
            style: (0, transform_1.transformToGraphic)(null === (_m = spec.background) || void 0 === _m ? void 0 : _m.style),
            state: (0, transform_1.transformStateStyle)(null === (_o = spec.background) || void 0 === _o ? void 0 : _o.state)
        }
    };
}
...
}, exports.getCommonAxis = getCommonAxis, exports.getAxisAttributes = getAxisAttributes;
