...
const EventHandler_1 = require("../../../../event/EventHandler"), dom_1 = require("../../../../tools/dom"), TABLE_EVENT_TYPE_1 = require("../../../../core/TABLE_EVENT_TYPE"), CLASSNAME = "vtable__menu-element", HIDDEN_CLASSNAME = `${CLASSNAME}--hidden`, SHOWN_CLASSNAME = `${CLASSNAME}--shown`;
