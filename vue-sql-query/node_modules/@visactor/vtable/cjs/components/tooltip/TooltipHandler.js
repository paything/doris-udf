...
const Tooltip_1 = require("./Tooltip"), helper_1 = require("../../tools/helper"), util_1 = require("../../tools/util"), TABLE_EVENT_TYPE_1 = require("../../core/TABLE_EVENT_TYPE"), vutils_1 = require("@visactor/vutils"), TOOLTIP_INSTANCE_FACTORY = {
...
class TooltipHandler {
    ...
    _bindTableEvent(table) {
        ...
        })), table.on(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.SELECTED_CELL, (e => {
            this._isBindCell(e.col, e.row) && this._unbindFromCell();
        })), table.on(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSELEAVE_TABLE, (e => {
            this._unbindFromCell();
        })), table.on(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.SCROLL, (e => {
            this._unbindFromCell();
        }));
    }
    showTooltip(col, row) {
        ...
        } else if ((0, vutils_1.isFunction)(null === (_b = table.internalProps.tooltip) || void 0 === _b ? void 0 : _b.isShowOverflowTextTooltip) ? table.internalProps.tooltip.isShowOverflowTextTooltip(col, row, table) : table.internalProps.tooltip.isShowOverflowTextTooltip) {
