...
const EventHandler_1 = require("../../../event/EventHandler"), ts_types_1 = require("../../../ts-types"), dom_1 = require("../../../tools/dom"), BubbleTooltipElementStyle_1 = require("./BubbleTooltipElementStyle"), util_1 = require("../../../tools/util");

(0, BubbleTooltipElementStyle_1.importStyle)();
...
class BubbleTooltipElement {
    constructor() {
        ...
        dom_1.createElement)("div", [ CONTENT_CLASS ]), triangle = (0, dom_1.createElement)("span", [ TRIANGLE_CLASS ]);
