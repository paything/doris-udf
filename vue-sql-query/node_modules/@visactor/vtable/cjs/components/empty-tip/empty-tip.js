...
class EmptyTip {
    constructor(emptyTipOption, table) {
        ...
        (0, vutils_1.isValid)(this._emptyTipOption.displayMode) || (this.table.isListTable() ? this._emptyTipOption.displayMode = "basedOnTable" : this._emptyTipOption.displayMode = "basedOnContainer"), 
    ...
    _createOrUpdateEmptyTipComponent(attrs) {
        if (this._emptyTipComponent) (0, vutils_1.isEqual)(attrs, this._cacheAttrs) || this._emptyTipComponent.setAttributes(attrs); else {
            const emptyTip = new vrender_1.EmptyTip(attrs);
    ...
    bindEvents() {
        this._emptyTipComponent.on("click", (e => {
            const bounds = new vutils_1.AABBBounds;
