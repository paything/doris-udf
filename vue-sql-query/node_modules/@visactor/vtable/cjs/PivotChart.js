...
class PivotChart extends BaseTable_1.BaseTable {
    constructor(container, options) {
        ...
        this.setCustomStateNameToSpec(), this.internalProps.columnResizeType = null !== (_e = null !== (_d = null === (_c = options.resize) || void 0 === _c ? void 0 : _c.columnResizeType) && void 0 !== _d ? _d : options.columnResizeType) && void 0 !== _e ? _e : "column", 
        ...
        this.internalProps.dataConfig = {
            isPivotChart: !0
        }, this._axes = (0, vutils_1.isArray)(options.axes) ? options.axes : [], options.columnTree && (!1 !== options.indicatorsAsCol && (this.internalProps.columnTree = (0, 
        layout_helper_1.supplementIndicatorNodesForCustomTree)(this.internalProps.columnTree, options.indicators)), 
        columnDimensionTree = new tree_helper_1.DimensionTree(null !== (_j = this.internalProps.columnTree) && void 0 !== _j ? _j : [], this.layoutNodeId)), 
        options.rowTree && (!1 === options.indicatorsAsCol && (this.internalProps.rowTree = (0, 
        layout_helper_1.supplementIndicatorNodesForCustomTree)(this.internalProps.rowTree, options.indicators)), 
        rowDimensionTree = new tree_helper_1.DimensionTree(null !== (_k = this.internalProps.rowTree) && void 0 !== _k ? _k : [], this.layoutNodeId));
        ...
        this.dataset = new dataset_1.Dataset(this.internalProps.dataConfig, rowKeys, columnKeys, indicatorKeys, this.internalProps.indicators, null === (_u = options.indicatorsAsCol) || void 0 === _u || _u, options.records, void 0, void 0, this.internalProps.columnTree, this.internalProps.rowTree, !0), 
        ...
        if (options.columnTree || !1 !== options.indicatorsAsCol && (this.dataset.colHeaderTree = (0, 
        ...
        columnDimensionTree = new tree_helper_1.DimensionTree(null !== (_w = this.dataset.colHeaderTree) && void 0 !== _w ? _w : [], this.layoutNodeId), 
        rowDimensionTree = new tree_helper_1.DimensionTree(null !== (_x = this.dataset.rowHeaderTree) && void 0 !== _x ? _x : [], this.layoutNodeId), 
    ...
    static get EVENT_TYPE() {
        return PIVOT_TABLE_EVENT_TYPE_1.PIVOT_CHART_EVENT_TYPE;
    }
    get pivotChartAxes() {
        return this._axes;
    }
    ...
    updateOption(options) {
        ...
        vutils_extension_1.cloneDeepSpec)(options.indicators) : [], this.internalProps.columnTree = !options.indicatorsAsCol || (null === (_b = options.columns) || void 0 === _b ? void 0 : _b.length) || options.columnTree ? (0, 
        ...
        this.setCustomStateNameToSpec(), this._selectedDataItemsInChart = [], internalProps.columnResizeType = null !== (_f = null !== (_e = null === (_d = options.resize) || void 0 === _d ? void 0 : _d.columnResizeType) && void 0 !== _e ? _e : options.columnResizeType) && void 0 !== _f ? _f : "column", 
        ...
        layout_helper_1.supplementIndicatorNodesForCustomTree)(this.internalProps.columnTree, options.indicators)), 
        columnDimensionTree = new tree_helper_1.DimensionTree(null !== (_k = this.internalProps.columnTree) && void 0 !== _k ? _k : [], this.layoutNodeId)), 
        options.rowTree && (!1 === options.indicatorsAsCol && (this.internalProps.rowTree = (0, 
        layout_helper_1.supplementIndicatorNodesForCustomTree)(this.internalProps.rowTree, options.indicators)), 
        rowDimensionTree = new tree_helper_1.DimensionTree(null !== (_l = this.internalProps.rowTree) && void 0 !== _l ? _l : [], this.layoutNodeId));
        ...
        this.internalProps.dataConfig.aggregationRules = this._generateAggregationRules(), 
        this.internalProps.dataConfig.dimensionSortArray = this._getDimensionSortArray(), 
        this.dataset = new dataset_1.Dataset(this.internalProps.dataConfig, rowKeys, columnKeys, indicatorKeys, this.internalProps.indicators, null === (_v = options.indicatorsAsCol) || void 0 === _v || _v, null !== (_w = options.records) && void 0 !== _w ? _w : this.internalProps.records, void 0, void 0, this.internalProps.columnTree, this.internalProps.rowTree, !0), 
        this.options.indicatorsAsCol && (0, get_chart_spec_1.checkHasCartesianChart)(this.internalProps.indicators)) {
            const supplyAxisNode = nodes => {
                nodes.forEach((node => {
                    var _a;
        ...
        options.rowTree || !1 === options.indicatorsAsCol && (this.dataset.rowHeaderTree = (0, 
        layout_helper_1.supplementIndicatorNodesForCustomTree)(this.dataset.rowHeaderTree, options.indicators)), 
        columnDimensionTree = new tree_helper_1.DimensionTree(null !== (_y = this.dataset.colHeaderTree) && void 0 !== _y ? _y : [], this.layoutNodeId), 
        rowDimensionTree = new tree_helper_1.DimensionTree(null !== (_z = this.dataset.rowHeaderTree) && void 0 !== _z ? _z : [], this.layoutNodeId), 
        ...
        for (let i = 0, len = null == indicators ? void 0 : indicators.length; i < len; i++) if ("string" != typeof indicators[i] && indicators[i].chartSpec) {
            ...
            collectValuesBy[indicatorDefine.indicatorKey] = {
                ...
                collectValuesBy[xField] = {
                    ...
                    range: (0, get_axis_config_1.hasLinearAxis)(chartSeries, this._axes, "horizontal" === chartSeries.direction, !0),
                ...
                collectValuesBy[yField] = {
                    by: rowKeys,
                    range: (0, get_axis_config_1.hasLinearAxis)(chartSeries, this._axes, "horizontal" === chartSeries.direction, !1),
    ...
    clearChartCacheImage(col, row) {
        (0, vutils_1.isNumber)(col) && (0, vutils_1.isNumber)(row) ? (0, update_chart_1.clearCellChartCacheImage)(col, row, this.scenegraph) : (0, 
        update_chart_1.clearChartCacheImage)(this.scenegraph);
    }
    getLegendSelected() {
        var _a;
        const selected = [];
    ...
    _getDimensionSortArray() {
        ...
        if (null === (_b = null === (_a = this.options) || void 0 === _a ? void 0 : _a.axes) || void 0 === _b ? void 0 : _b.length) {
            ...
            if (dimensionAxisOption && (0, vutils_1.isArray)(dimensionAxisOption.domain)) return dimensionAxisOption.domain;
        }
    }
    setRecords(records) {
        var _a, _b;
        this.internalProps.layoutMap.release(), (0, chart_render_helper_1.clearChartRenderQueue)();
        const oldHoverState = {
