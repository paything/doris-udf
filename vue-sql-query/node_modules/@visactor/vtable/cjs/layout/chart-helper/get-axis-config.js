...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getAxisRangeAndTicks = exports.hasLinearAxis = exports.isLeftOrRightAxis = exports.isTopOrBottomAxis = exports.getAxisRange = exports.getAxisOption = exports.getAxisConfigInPivotChart = void 0;

const vutils_1 = require("@visactor/vutils"), zero_align_1 = require("./zero-align"), factory_1 = require("../../core/factory"), padding_1 = require("../../scenegraph/utils/padding"), get_prop_1 = require("../../scenegraph/utils/get-prop"), tick_align_1 = require("./tick-align");
...
function getAxisConfigInPivotChart(col, row, layout) {
    ...
    if (layout._table.isPivotChart()) if (layout.indicatorsAsCol) {
        if (layout.hasTwoIndicatorAxes && row === layout.columnHeaderLevelCount - 1 && col >= layout.rowHeaderLevelCount && col < layout.colCount - layout.rightFrozenColCount) {
            ...
            if (!axisRange) return;
            const chartCellStyle = layout._table._getCellStyle(col, row + 1), padding = (0, 
            padding_1.getQuadProps)((0, get_prop_1.getProp)("padding", chartCellStyle, col, row + 1, layout._table)), {range: range, ticks: ticks, axisOption: axisOption, targetTicks: targetTicks, targetRange: targetRange, index: index, theme: theme} = axisRange;
        ...
        if (row === layout.rowCount - layout.bottomFrozenRowCount && col >= layout.rowHeaderLevelCount && col < layout.colCount - layout.rightFrozenColCount) {
            ...
            if (!axisRange) return;
            const chartCellStyle = layout._table._getCellStyle(col, row - 1), padding = (0, 
            padding_1.getQuadProps)((0, get_prop_1.getProp)("padding", chartCellStyle, col, row - 1, layout._table)), {range: range, ticks: ticks, axisOption: axisOption, index: index, targetTicks: targetTicks, targetRange: targetRange, theme: theme} = axisRange;
            return (0, vutils_1.isNumber)(null == axisOption ? void 0 : axisOption.min) && (range.min = axisOption.min, 
            range.min > 0 && (axisOption.zero = !1)), (0, vutils_1.isNumber)(null == axisOption ? void 0 : axisOption.max) && (range.max = axisOption.max, 
            range.max < 0 && (axisOption.zero = !1)), (0, vutils_1.merge)({
                title: {
        ...
        if (col === layout.rowHeaderLevelCount - 1 && row >= layout.columnHeaderLevelCount && row < layout.rowCount - layout.bottomFrozenRowCount) {
            ...
            const chartCellStyle = layout._table._getCellStyle(col + 1, row), padding = (0, 
            padding_1.getQuadProps)((0, get_prop_1.getProp)("padding", chartCellStyle, col + 1, row, layout._table)), spec = layout.getRawChartSpec(col + 1, row);
        ...
        if (col === layout.rowHeaderLevelCount - 1 && row >= layout.columnHeaderLevelCount && row < layout.rowCount - layout.bottomFrozenRowCount) {
            ...
            if (!axisRange) return;
            const chartCellStyle = layout._table._getCellStyle(col + 1, row), padding = (0, 
            padding_1.getQuadProps)((0, get_prop_1.getProp)("padding", chartCellStyle, col + 1, row, layout._table)), {range: range, ticks: ticks, axisOption: axisOption, index: index, targetTicks: targetTicks, targetRange: targetRange, theme: theme} = axisRange;
            return (0, vutils_1.isNumber)(null == axisOption ? void 0 : axisOption.min) && (range.min = axisOption.min, 
            range.min > 0 && (axisOption.zero = !1)), (0, vutils_1.isNumber)(null == axisOption ? void 0 : axisOption.max) && (range.max = axisOption.max, 
            range.max < 0 && (axisOption.zero = !1)), (0, vutils_1.merge)({
                title: {
        ...
        if (row === layout.rowCount - layout.bottomFrozenRowCount && col >= layout.rowHeaderLevelCount && col < layout.colCount - layout.rightFrozenColCount) {
            ...
            if (!1 === (null == axisOption ? void 0 : axisOption.visible)) return;
            const chartCellStyle = layout._table._getCellStyle(col, row - 1), padding = (0, 
            padding_1.getQuadProps)((0, get_prop_1.getProp)("padding", chartCellStyle, col, row - 1, layout._table));
            return (0, vutils_1.merge)({
                domain: "linear" === (null == axisOption ? void 0 : axisOption.type) ? void 0 : Array.from(domain),
                range: "linear" === (null == axisOption ? void 0 : axisOption.type) ? domain : void 0
            }, axisOption, {
...
function getAxisOption(col, row, orient, layout) {
    ...
    if (layout._table.pivotChartAxes.forEach((axis => {
        ...
        if (axisOption) {
            ...
            (0, vutils_1.isValid)(seriesId) && (0, vutils_1.isArray)(spec.series) ? seriesIndice = ((0, 
            vutils_1.isArray)(seriesId) ? seriesId : [ seriesId ]).map((id => {
                const index = spec.series.findIndex((s => s.id === id));
                return index >= 0 && (seriesSpec = spec.series[index]), index;
            })) : (0, vutils_1.isValid)(seriesIndex) && (0, vutils_1.isArray)(spec.series) && (seriesIndice = seriesIndex);
...
function checkZeroAlign(spec, orient, layout) {
    ...
    axesSpec = spec && (0, vutils_1.isArray)(spec.axes) ? spec.axes : layout._table.pivotChartAxes;
...
function getAxisRange(collectedValues, indicatorKeys, isZeroAlign, colPath, seriesId) {
    var _a;
    if ((0, vutils_1.isArray)(seriesId)) {
        const range = {
            min: 1 / 0,
            max: -1 / 0
        };
...
function transformInverse(spec, isHorizontal) {
    ...
    return isHorizontal && !isXAxis(null == spec ? void 0 : spec.orient) && (inverse = !(0, 
    vutils_1.isValid)(null == spec ? void 0 : spec.inverse) || !(null == spec ? void 0 : spec.inverse)), 
    inverse;
}
...
function hasLinearAxis(spec, tableAxesConfig, isHorizontal, isThisXAxis) {
    if (!(0, vutils_1.isArray)(spec.axes) || 0 === spec.axes.length) return isHorizontal && isThisXAxis || !isHorizontal && !isThisXAxis;
    ...
    if ((0, vutils_1.isArray)(tableAxesConfig) && tableAxesConfig.length > 0) for (let i = 0; i < tableAxesConfig.length; i++) {
...
function getAxisRangeAndTicks(col, row, index, position, subAxisPosition, indicatorKeys, path, layout) {
    ...
    if (0 !== index && targetTicks) {
        const getAxisDomainRangeAndLabels = factory_1.Factory.getFunction("getAxisDomainRangeAndLabels"), {range: newRange, ticks: newTicks} = getAxisDomainRangeAndLabels(range.min, range.max, (0, 
        vutils_1.merge)({}, axisOption, {
            nice: !0,
            tick: {
...
function getTargetRangeAndTicks(col, row, index, isZeroAlign, isTickAlign, range, indicatorKeys, subAxisPosition, path, layout) {
    ...
    if (subAxisRange) {
        ...
        if (targetRange = subRange, isZeroAlign) {
            const align = (0, zero_align_1.getNewRangeToAlign)(range, subRange);
            align && (range.min = align.range1[0], range.max = align.range1[1], targetRange.min = align.range2[0], 
            targetRange.max = align.range2[1]);
        }
        isTickAlign && (targetTicks = isZeroAlign ? (0, tick_align_1.getZeroAlignTickAlignTicks)(targetRange, col, row, index, subAxisPosition, layout) : subTicks);
    }
    return {
        targetTicks: targetTicks,
        targetRange: targetRange
...
exports.getAxisRange = getAxisRange, exports.isTopOrBottomAxis = isTopOrBottomAxis, 
exports.isLeftOrRightAxis = isLeftOrRightAxis, function(Direction) {
    Direction.vertical = "vertical", Direction.horizontal = "horizontal";
}(Direction || (Direction = {})), exports.hasLinearAxis = hasLinearAxis, exports.getAxisRangeAndTicks = getAxisRangeAndTicks;
