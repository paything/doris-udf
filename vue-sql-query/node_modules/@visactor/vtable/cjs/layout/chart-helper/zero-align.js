...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getNewRangeToAlign = void 0;
...
function getScaleInfo(domain) {
    ...
    return 0 === total ? domain[0] < 0 ? (negative = 1, positive = 0) : domain[0] > 0 && (negative = 0, 
...
function getNewRangeToAlign(range1, range2) {
    const domain1 = [ range1.min, range1.max ], domain2 = [ range2.min, range2.max ];
...
exports.getNewRangeToAlign = getNewRangeToAlign;
//# sourceMappingURL=zero-align.js.map
