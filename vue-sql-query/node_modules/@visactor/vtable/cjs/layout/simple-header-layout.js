...
const vutils_1 = require("@visactor/vutils"), global_1 = require("../tools/global"), ts_types_1 = require("../ts-types"), get_chart_spec_1 = require("./chart-helper/get-chart-spec"), layout_helper_1 = require("./layout-helper"), tree_helper_1 = require("./tree-helper"), simple_cell_range_1 = require("./cell-range/simple-cell-range");
...
class SimpleHeaderLayoutMap {
    constructor(table, columns, showHeader, hierarchyIndent) {
        ...
        this.rowHierarchyType = (0, layout_helper_1.checkHasTreeDefine)(this) ? "tree" : "grid", 
    ...
    getCellRange(col, row) {
        return (0, simple_cell_range_1.getCellRange)(col, row, this);
    }
        ...
        return column.forEach((hd => {
            ...
            if (hd.columns && expand) {
                ...
                const colDef = {
                    ...
                    sparklineSpec: "sparklineSpec" in hd ? hd.sparklineSpec : global_1.DefaultSparklineSpec,
                    style: hd.style,
                    define: hd,
                    columnWidthComputeMode: hd.columnWidthComputeMode,
