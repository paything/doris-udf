...
const util_1 = require("../tools/util"), ts_types_1 = require("../ts-types"), global_1 = require("../tools/global"), diff_cell_1 = require("../tools/diff-cell"), get_chart_spec_1 = require("./chart-helper/get-chart-spec"), tree_helper_1 = require("./tree-helper"), vutils_1 = require("@visactor/vutils"), padding_1 = require("../scenegraph/utils/padding"), factory_1 = require("../core/factory"), defaultDimension = {
    startInTotal: 0,
    afterSpanLevel: 0
};
...
class PivotHeaderLayoutMap {
    ...
    _addHeaders(_headerCellIds, row, header, roots, results) {
        ...
        for (let i = 0; i < header.length; i++) {
            const hd = header[i];
            (0, tree_helper_1.dealHeader)(hd, _headerCellIds, results, roots, row, this);
        }
    }
    ...
    generateExtensionRowTree() {
        this.extensionRows.forEach(((extensionRow, indexP) => {
            ...
            this._rowHeaderCellFullPathIds_FULL = [], old_rowHeaderCellIds.forEach(((row_ids, index) => {
                ...
                rowExtensionDimensionTree = this._rowHeaderExtensionTree[key]) : (rowExtensionDimensionTree = new tree_helper_1.DimensionTree(null != tree ? tree : [], this.sharedVar, this.rowHierarchyType, void 0), 
    ...
    getBody(_col, _row) {
        ...
        if (this.indicatorsAsCol) {
            const indicatorKey = null === (_b = null === (_a = paths.colHeaderPaths) || void 0 === _a ? void 0 : _a.find((colPath => colPath.indicatorKey))) || void 0 === _b ? void 0 : _b.indicatorKey, body = (0, 
            vutils_1.isValid)(indicatorKey) && null !== (_e = null !== (_d = null === (_c = this._indicators) || void 0 === _c ? void 0 : _c.find((indicator => indicator.indicatorKey === indicatorKey))) && void 0 !== _d ? _d : this._indicators[0]) && void 0 !== _e ? _e : {
                id: "",
                field: void 0,
                indicatorKey: void 0,
                cellType: "text",
        ...
        const indicatorKey = null === (_g = null === (_f = paths.rowHeaderPaths) || void 0 === _f ? void 0 : _f.find((rowPath => rowPath.indicatorKey))) || void 0 === _g ? void 0 : _g.indicatorKey, body = (0, 
        vutils_1.isValid)(indicatorKey) && null !== (_k = null !== (_j = null === (_h = this._indicators) || void 0 === _h ? void 0 : _h.find((indicator => indicator.indicatorKey === indicatorKey))) && void 0 !== _j ? _j : this._indicators[0]) && void 0 !== _k ? _k : {
            id: "",
            field: void 0,
            indicatorKey: void 0,
            cellType: "text",
    ...
    getPivotCellAdress(dimensions) {
        ...
        for (let i = 0; i < dimensions.length; i++) {
            ...
            for (let j = 0; j < colArr.length; j++) {
                ...
                if (((0, vutils_1.isValid)(highlightDimension.dimensionKey) && dimension.dimensionKey === highlightDimension.dimensionKey || (0, 
                vutils_1.isValid)(highlightDimension.indicatorKey) && dimension.indicatorKey === highlightDimension.indicatorKey) && dimension.value === highlightDimension.value) {
    ...
    getCellAdressByHeaderPath(dimensionPaths) {
        ...
        if (colHeaderPaths) for (let i = 0; i < colHeaderPaths.length; i++) {
            ...
            for (let j = 0; j < colArr.length; j++) {
                const dimension = colArr[j];
                if (!(0, vutils_1.isValid)(colDimension.indicatorKey) && dimension.dimensionKey === colDimension.dimensionKey && dimension.value === colDimension.value || (0, 
        ...
        if (forceBody || !needLowestLevel_colPaths || !needLowestLevel_rowPaths || (rowDimensionFinded || (0, 
    ...
    getAxisConfigInPivotChart(col, row) {
        if ((this.isFrozenColumn(col, row) || this.isRightFrozenColumn(col, row)) && (0, 
        get_chart_spec_1.isHasCartesianChartInline)(col, row, "row", this) || (this.isFrozenRow(col, row) || this.isBottomFrozenRow(col, row)) && (0, 
        get_chart_spec_1.isHasCartesianChartInline)(col, row, "col", this)) {
            const config = factory_1.Factory.getFunction("getAxisConfigInPivotChart")(col, row, this);
    ...
    getChartAxes(col, row) {
        if ((0, get_chart_spec_1.isCartesianChart)(col, row, this) || this.isAxisCell(col, row)) return (0, 
        get_chart_spec_1.getChartAxes)(col, row, this);
    }
    ...
    isShareChartSpec(col, row) {
        return (0, get_chart_spec_1.isShareChartSpec)(col, row, this);
    }
    getChartDataId(col, row) {
        return (0, get_chart_spec_1.getChartDataId)(col, row, this);
    }
    isNoChartDataRenderNothing(col, row) {
        return (0, get_chart_spec_1.isNoChartDataRenderNothing)(col, row, this);
    }
    ...
    getLayoutColumnTree() {
        ...
        return (0, tree_helper_1.generateLayoutTree)(tree, children), tree;
    }
    getLayoutRowTree() {
    ...
    getLayoutColumnTreeCount() {
        ...
        return (0, tree_helper_1.countLayoutTree)(children, "tree" === this.rowHierarchyType);
    }
    getLayoutRowTreeCount() {
        var _a;
        const children = this.rowDimensionTree.tree.children;
        let totalCount = (0, tree_helper_1.countLayoutTree)(children, "tree" === this.rowHierarchyType);
        return null === (_a = this.extensionRows) || void 0 === _a || _a.forEach((extensionRow => {
            if ("function" != typeof extensionRow.rowTree) {
                const thisTreeCount = (0, tree_helper_1.countLayoutTree)(extensionRow.rowTree, !0);
    ...
    isSeriesNumber(col, row) {
        if ((0, vutils_1.isValid)(col) && (0, vutils_1.isValid)(row)) {
