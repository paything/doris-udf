...
class Scenegraph {
    ...
    createFrameBorder() {
        ...
        (0, frame_border_1.createFrameBorder)(this.rowHeaderGroup, this.isPivot || this.table.internalProps.transpose ? this.table.theme.rowHeaderStyle.frameStyle : this.table.theme.bodyStyle.frameStyle, this.rowHeaderGroup.role, isListTableWithFrozen ? [ !0, !1, !0, !0 ] : void 0), 
        ...
        (null === (_a = this.table.theme.cornerLeftBottomCellStyle) || void 0 === _a ? void 0 : _a.frameStyle) && (0, 
        frame_border_1.createFrameBorder)(this.leftBottomCornerGroup, this.table.theme.cornerLeftBottomCellStyle.frameStyle, this.leftBottomCornerGroup.role, isListTableWithFrozen ? [ !0, !1, !0, !0 ] : void 0), 
        (null === (_b = this.table.theme.bottomFrozenStyle) || void 0 === _b ? void 0 : _b.frameStyle) && (0, 
        frame_border_1.createFrameBorder)(this.bottomFrozenGroup, this.table.theme.bottomFrozenStyle.frameStyle, this.bottomFrozenGroup.role, isListTableWithFrozen ? [ !0, !0, !0, !1 ] : void 0), 
        (null === (_c = this.table.theme.rightFrozenStyle) || void 0 === _c ? void 0 : _c.frameStyle) && (0, 
        frame_border_1.createFrameBorder)(this.rightFrozenGroup, this.table.theme.rightFrozenStyle.frameStyle, this.rightFrozenGroup.role, void 0), 
        (null === (_d = this.table.theme.cornerRightTopCellStyle) || void 0 === _d ? void 0 : _d.frameStyle) && (0, 
        frame_border_1.createFrameBorder)(this.rightTopCornerGroup, this.table.theme.cornerRightTopCellStyle.frameStyle, this.rightTopCornerGroup.role, void 0), 
        (null === (_e = this.table.theme.cornerRightBottomCellStyle) || void 0 === _e ? void 0 : _e.frameStyle) && (0, 
        frame_border_1.createFrameBorder)(this.rightBottomCornerGroup, this.table.theme.cornerRightBottomCellStyle.frameStyle, this.rightBottomCornerGroup.role, void 0), 
    ...
    updateBorderSizeAndPosition() {
        ...
        frame_border_1.updateFrameBorderSize)(this.bodyGroup), this.rowHeaderGroup.attribute.width, 
        (0, frame_border_1.updateFrameBorder)(this.bodyGroup, this.table.theme.bodyStyle.frameStyle)), 
        this.colHeaderGroup.border && (this.colHeaderGroup.appendChild(this.colHeaderGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.colHeaderGroup), this.cornerHeaderGroup.attribute.width, 
        (0, frame_border_1.updateFrameBorder)(this.colHeaderGroup, this.table.theme.headerStyle.frameStyle)), 
        this.rowHeaderGroup.border && (this.rowHeaderGroup.appendChild(this.rowHeaderGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.rowHeaderGroup)), this.cornerHeaderGroup.border && (this.cornerHeaderGroup.appendChild(this.cornerHeaderGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.cornerHeaderGroup)), this.leftBottomCornerGroup.border && (this.leftBottomCornerGroup.appendChild(this.leftBottomCornerGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.leftBottomCornerGroup)), this.bottomFrozenGroup.border && (this.bottomFrozenGroup.appendChild(this.bottomFrozenGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.bottomFrozenGroup)), this.rightFrozenGroup.border && (this.rightFrozenGroup.appendChild(this.rightFrozenGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.rightFrozenGroup)), this.rightTopCornerGroup.border && (this.rightTopCornerGroup.appendChild(this.rightTopCornerGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.rightTopCornerGroup)), this.rightBottomCornerGroup.border && (this.rightBottomCornerGroup.appendChild(this.rightBottomCornerGroup.border), 
        (0, frame_border_1.updateFrameBorderSize)(this.rightBottomCornerGroup)), (0, frame_border_1.updateCornerRadius)(this.table);
    }
    sortCell() {
    ...
    updateCellContent(col, row, forceFastUpdate = !1) {
        if (!this.clear) return (0, cell_helper_1.updateCell)(col, row, this.table, void 0, void 0, forceFastUpdate);
    }
    ...
    updateRow(removeCells, addCells, updateCells = [], recalculateColWidths = !0, skipUpdateProxy) {
        ...
        if ((0, update_row_1.updateRow)(removeCells, addCells, updateCells, this.table, skipUpdateProxy), 
    ...
    updateCornerHeaderCells() {
        for (let col = 0; col < this.table.frozenColCount; col++) for (let row = 0; row < this.table.frozenRowCount; row++) (0, 
        cell_helper_1.updateCell)(col, row, this.table, !1);
    }
    updateRowHeaderCells() {
        for (let col = 0; col < this.table.frozenColCount; col++) for (let row = this.table.frozenRowCount; row < this.table.rowCount; row++) (0, 
        cell_helper_1.updateCell)(col, row, this.table, !1);
    }
    updateColumnHeaderCells() {
        for (let row = 0; row < this.table.frozenRowCount; row++) for (let col = this.table.frozenColCount; col < this.table.colCount; col++) (0, 
        cell_helper_1.updateCell)(col, row, this.table, !1);
    }
    getColumnGroupX(col) {
    ...
    updateDomContainer() {
        (0, frozen_react_1.updateReactContainer)(this.table);
    }
    setLoadingHierarchyState(col, row) {
        ...
        if (iconGraphic) {
            const loadingIcon = registerIcons.get()[ts_types_1.InternalIconName.loadingIconName];
            loadingIcon && (0, text_icon_layout_1.dealWithIcon)(loadingIcon, iconGraphic, col, row);
        }
    }
    temporarilyUpdateSelectRectStyle(rectAttribute) {
        (0, update_select_style_1.temporarilyUpdateSelectRectStyle)(rectAttribute, this);
    }
