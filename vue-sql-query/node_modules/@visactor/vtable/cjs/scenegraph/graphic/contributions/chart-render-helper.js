...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.cacheStageCanvas = exports.startRenderChartQueue = exports.renderChart = exports.IsHandlingChartQueue = exports.clearChartRenderQueue = exports.setBatchRenderChartCount = exports.chartRenderQueueList = exports.chartRenderKeys = exports.cancelRenderChartQueue = void 0;
...
function setBatchRenderChartCount(count) {
    (0, vutils_1.isValid)(count) && (batchRenderChartCount = count);
}

function clearChartRenderQueue() {
    exports.chartRenderKeys = [], exports.chartRenderQueueList = [], isHandlingChartQueue = !1, 
...
function startRenderChartQueue(table) {
    isHandlingChartQueue = !0, exports.chartRenderQueueList.length > 0 ? requestAnimationFrameId = requestAnimationFrame((() => {
        const chartsToRender = exports.chartRenderQueueList.splice(0, batchRenderChartCount);
        exports.chartRenderKeys.splice(0, batchRenderChartCount), chartsToRender.forEach((chart => {
            renderChart(chart), chart.addUpdateBoundTag();
        })), table.render(), startRenderChartQueue(table);
    })) : isHandlingChartQueue = !1;
}

exports.setBatchRenderChartCount = setBatchRenderChartCount, exports.clearChartRenderQueue = clearChartRenderQueue, 
exports.IsHandlingChartQueue = IsHandlingChartQueue, exports.renderChart = renderChart, 
exports.startRenderChartQueue = startRenderChartQueue;
