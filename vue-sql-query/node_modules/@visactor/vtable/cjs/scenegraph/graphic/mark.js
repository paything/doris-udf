...
function createMark(marked, cellGroup, table) {
    if ("boolean" == typeof marked) {
        ...
        fill = bgColor, mark = (0, vrender_1.createArc)({
            x: x,
            y: y,
            ...
            fill = bgColor, mark = (0, vrender_1.createPolygon)({
                points: [ {
                    x: x,
                    y: y
                }, {
        ...
        y = cellGroup.attribute.height - size - offset), fill = bgColor, mark = (0, vrender_1.createRect)({
            x: x,
            y: y,
            width: size,
            height: size,
