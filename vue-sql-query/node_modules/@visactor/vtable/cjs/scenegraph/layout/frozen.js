...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.resetRowFrozen = exports.dealBottomFrozen = exports.dealRightFrozen = exports.resetFrozen = exports.dealFrozen = void 0;

const tableHelper_1 = require("../../core/tableHelper"), group_1 = require("../graphic/group"), column_1 = require("../group-creater/column"), get_prop_1 = require("../utils/get-prop"), frozen_react_1 = require("./frozen-react");
...
function resetFrozen(scene) {
    ...
    (0, frozen_react_1.updateReactComponentContainer)(scene), scene.recreateAllSelectRangeComponents(), 
...
function moveColumnFromBodyToRowHeader(scene) {
    const column = scene.bodyGroup.firstChild instanceof group_1.Group ? scene.bodyGroup.firstChild : null;
...
function moveColumnFromColHeaderToCornerHeader(scene) {
    const headerColumn = scene.colHeaderGroup.firstChild instanceof group_1.Group ? scene.colHeaderGroup.firstChild : null;
...
function moveColumnFromRowHeaderToBody(scene) {
    var _a;
    const column = scene.rowHeaderGroup.lastChild instanceof group_1.Group ? scene.rowHeaderGroup.lastChild : null === (_a = scene.rowHeaderGroup.lastChild) || void 0 === _a ? void 0 : _a._prev;
...
function moveColumnFromCornerHeaderToColHeader(scene) {
    var _a;
    const headerColumn = scene.cornerHeaderGroup.lastChild instanceof group_1.Group ? scene.cornerHeaderGroup.lastChild : null === (_a = scene.cornerHeaderGroup.lastChild) || void 0 === _a ? void 0 : _a._prev;
...
function moveColumnFromBottomToLeftBottomCorner(scene) {
    const column = scene.bottomFrozenGroup.firstChild instanceof group_1.Group ? scene.bottomFrozenGroup.firstChild : null;
...
function moveColumnFromLeftBottomCornerToBottom(scene) {
    var _a;
    const column = scene.leftBottomCornerGroup.lastChild instanceof group_1.Group ? scene.leftBottomCornerGroup.lastChild : null === (_a = scene.leftBottomCornerGroup.lastChild) || void 0 === _a ? void 0 : _a._prev;
    ...
    scene.table.isPivotChart() && column.forEachChildren((child => {
        var _a, _b, _c, _d;
        const cellStyle = scene.table._getCellStyle(child.col, child.row), range = scene.table.getCellRange(child.col, child.row), cellTheme = (0, 
        tableHelper_1.getStyleTheme)(cellStyle, scene.table, range ? range.start.col : child.col, range ? range.start.row : child.row, get_prop_1.getProp).theme;
        child.setAttributes({
...
function dealBottomFrozen(distBottomFrozenRow, scene) {
    ...
    bottomFrozenGroup.childrenCount || (proxy.table.isPivotChart() || ((0, column_1.createColGroup)(leftBottomCornerGroup, 0, 0, 0, table.frozenColCount - 1, 0, -1, "rowHeader", table), 
    (0, column_1.createColGroup)(rightBottomCornerGroup, 0, 0, table.colCount - table.rightFrozenColCount, table.colCount - 1, 0, -1, "body", table)), 
    (0, column_1.createColGroup)(bottomFrozenGroup, 0, 0, proxy.colStart, proxy.colEnd, 0, -1, "body", table));
...
function checkBeforeMove(child) {
    return child instanceof group_1.Group && "table-border-rect" !== (null == child ? void 0 : child.name);
}

exports.dealFrozen = dealFrozen, exports.resetFrozen = resetFrozen, exports.dealRightFrozen = dealRightFrozen, 
exports.dealBottomFrozen = dealBottomFrozen, exports.resetRowFrozen = resetRowFrozen;
