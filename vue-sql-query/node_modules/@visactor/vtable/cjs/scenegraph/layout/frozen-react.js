...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.updateReactComponentContainer = exports.updateReactContainer = exports.createReactContainer = void 0;

const util_1 = require("../../event/util");
...
function updateReactComponentContainer(scene) {
    ...
    for (const key in htmlMap) {
        ...
        if (scene.frozenColCount > table.frozenColCount) {
            const targetCell = (0, util_1.getTargetCell)(graphic);
...
exports.createReactContainer = createReactContainer, exports.updateReactContainer = updateReactContainer, 
exports.updateReactComponentContainer = updateReactComponentContainer;
