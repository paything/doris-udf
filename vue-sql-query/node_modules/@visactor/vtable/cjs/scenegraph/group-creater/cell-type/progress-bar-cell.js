...
const vrender_1 = require("./../../../vrender"), helper_1 = require("../../../tools/helper"), group_1 = require("../../graphic/group"), get_prop_1 = require("../../utils/get-prop"), padding_1 = require("../../utils/padding"), vutils_1 = require("@visactor/vutils");
...
function createProgressBarCell(progressBarDefine, style, width, value, dataValue, col, row, padding, table, range) {
    ...
    if (progressBarDefine.dependField) {
        const dependField = (0, helper_1.getOrApply)(progressBarDefine.dependField, {
            col: col,
            row: row,
            table: table,
            value: value,
    ...
    const barType = null !== (_c = (0, helper_1.getOrApply)(progressBarDefine.barType, {
        col: col,
        row: row,
        table: table,
        value: value,
        dataValue: dataValue,
        cellHeaderPaths: void 0
    })) && void 0 !== _c ? _c : "default", min = null !== (_d = (0, helper_1.getOrApply)(progressBarDefine.min, {
        col: col,
        row: row,
        table: table,
        value: value,
        dataValue: dataValue,
        cellHeaderPaths: void 0
    })) && void 0 !== _d ? _d : 0, max = null !== (_e = (0, helper_1.getOrApply)(progressBarDefine.max, {
        col: col,
        row: row,
        table: table,
        value: value,
    ...
    (0, vutils_1.isNumber)(table.theme._contentOffset) && (_contentOffset = table.theme._contentOffset);
    const percentCompleteBarGroup = new group_1.Group({
        x: -_contentOffset,
        y: -_contentOffset,
        width: contentWidth,
    ...
    barPadding = barPadding.map(((v, i) => {
        if ("string" == typeof v && helper_1.str.endsWith(v, "%")) {
            const num = Number(v.substr(0, v.length - 1));
            return 0 === i || 2 === i ? height * num / 100 : width * num / 100;
        }
        return Number(v);
    }));
    const borderWidth = (0, padding_1.getQuadProps)((0, get_prop_1.getProp)("borderLineWidth", style, col, row, table)), barPaddingTop = Math.max(barPadding[0], Math.ceil(borderWidth[0] / 2));
    ...
    if ((0, helper_1.getOrApply)(showBar, {
        col: col,
        row: row,
        table: table,
        context: null,
        ...
        helper_1.str.endsWith(svalue, "%") && (svalue = svalue.substr(0, svalue.length - 1));
        ...
        if ("default" === (null != barType ? barType : "default")) {
            ...
            if (bgFillColor) {
                const barBack = (0, vrender_1.createRect)({
                    x: barLeft,
                    y: barTop,
                    width: barMaxWidth,
                    height: barHeight,
            ...
            const fillColor = (0, helper_1.getOrApply)(barColor, {
                col: col,
                row: row,
                table: table,
                context: null,
                ...
                dataValue: dataValue,
                percentile: percentile
            }) || "#20a8d8", barMain = (0, vrender_1.createRect)({
                x: barLeft,
                y: barTop,
                width: barSize,
                height: barHeight,
            ...
            const negativeRange = min < 0 ? -min : 0, positiveRange = max > 0 ? max : 0, negativeFactor = negativeRange / (negativeRange + positiveRange), positiveFactor = 1 - negativeFactor, positiveRate = num > 0 ? num / positiveRange : 0, negativeRate = num < 0 ? -num / negativeRange : 0, barMaxWidth = contentWidth, barTop = top + contentHeight - barHeight - barBottom, barLeft = left, bgFillColor = (0, 
            ...
            const positiveLeft = barRightToLeft ? positiveFactor * barMaxWidth : negativeFactor * barMaxWidth, barSizeNega = Math.min(barMaxWidth * negativeFactor * negativeRate, barMaxWidth), barRectNega = barRightToLeft ? {
                ...
                width: barSizeNega,
                height: barHeight
            }, barNagiFillColor = (0, helper_1.getOrApply)(barNegativeColor, {
                col: col,
                row: row,
                table: table,
                context: null,
            ...
            }) || "#20a8d8", barNega = (0, vrender_1.createRect)({
                x: barRectNega.left,
                y: barRectNega.top,
            ...
            const barRectPosi = barRightToLeft ? {
                ...
                width: barSizePosi,
                height: barHeight
            }, barPosiFillColor = (0, helper_1.getOrApply)(barPositiveColor, {
                col: col,
                row: row,
                table: table,
                context: null,
                ...
                dataValue: dataValue,
                percentile: positiveRate
            }) || "#20a8d8", barPosi = (0, vrender_1.createRect)({
                x: barRectPosi.left,
                y: barRectPosi.top,
            ...
            const lineLeft = barRightToLeft ? barRectNega.left : barRectPosi.left, lineStrokeColor = (0, 
            helper_1.getOrApply)(barAxisColor, {
                col: col,
                row: row,
                table: table,
                context: null,
            ...
            if (percentCompleteBarGroup.addChild(line), showBarMark && (positiveRate || negativeRate)) {
                ...
                if (positiveRate > 0) if (barMarkStrokeColor = (0, helper_1.getOrApply)(barMarkPositiveColor, {
                    col: col,
                    row: row,
                    table: table,
                    context: null,
                    ...
                    y: barRectPosi.top + barRectPosi.height - barMarkWidth / 2
                })); else if (negativeRate > 0) if (barMarkStrokeColor = (0, helper_1.getOrApply)(barMarkNegativeColor, {
                    col: col,
                    row: row,
                    table: table,
                    context: null,
                ...
                const barMark = (0, vrender_1.createLine)({
                    x: 0,
                    y: 0,
            ...
            barRectFillColor = num >= 0 ? (0, helper_1.getOrApply)(barPositiveColor, {
                col: col,
                row: row,
                table: table,
                context: null,
                ...
                percentile: percentile,
                dataValue: dataValue
            }) || "#20a8d8" : (0, helper_1.getOrApply)(barNegativeColor, {
                col: col,
                row: row,
                table: table,
                context: null,
            ...
            const bar = (0, vrender_1.createRect)({
                x: barRect.left,
                y: barRect.top,
                width: barRect.width,
            ...
            if (percentCompleteBarGroup.addChild(bar), showBarMark && num) {
                const lineWidth = barMarkWidth, points = [];
                let barMarkStrokeColor;
                if (barMarkStrokeColor = num >= 0 ? (0, helper_1.getOrApply)(barMarkPositiveColor, {
                    col: col,
                    row: row,
                    table: table,
                    context: null,
                    ...
                    dataValue: dataValue,
                    percentile: percentile
                }) || "#20a8d8" : (0, helper_1.getOrApply)(barMarkNegativeColor, {
                    col: col,
                    row: row,
                    table: table,
                    context: null,
...
exports.createProgressBarCell = createProgressBarCell;
