...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.createCheckboxCellGroup = void 0;

const group_1 = require("../../graphic/group"), vutils_1 = require("@visactor/vutils"), vrender_1 = require("./../../../vrender"), get_hierarchy_offset_1 = require("../../utils/get-hierarchy-offset"), helper_1 = require("../../../tools/helper"), get_prop_1 = require("../../utils/get-prop"), cell_border_stroke_width_1 = require("../../utils/cell-border-stroke-width"), text_icon_layout_1 = require("../../utils/text-icon-layout");
...
function createCheckbox(col, row, colWidth, cellWidth, cellHeight, padding, cellTheme, define, table) {
    var _a, _b, _c, _d;
    const style = table._getCellStyle(col, row), size = (0, get_prop_1.getProp)("size", style, col, row, table), spaceBetweenTextAndIcon = (0, 
    get_prop_1.getProp)("spaceBetweenTextAndIcon", style, col, row, table), defaultFill = (0, 
    ...
    get_prop_1.getProp)("disableCheckedStroke", style, col, row, table), checkIconImage = (0, 
    get_prop_1.getProp)("checkIconImage", style, col, row, table), indeterminateIconImage = (0, 
    get_prop_1.getProp)("indeterminateIconImage", style, col, row, table), value = table.getCellValue(col, row), dataValue = table.getCellOriginValue(col, row);
    ...
    const hierarchyOffset = (0, get_hierarchy_offset_1.getHierarchyOffset)(col, row, table), cellStyle = table._getCellStyle(col, row), autoWrapText = null !== (_c = cellStyle.autoWrapText) && void 0 !== _c ? _c : table.internalProps.autoWrapText, {lineClamp: lineClamp} = cellStyle, {checked: checked, disable: disable} = define;
    ...
    const checkbox = new vrender_1.CheckBox(checkboxAttributes);
    return checkbox.name = "checkbox", checkbox;
}

exports.createCheckboxCellGroup = createCheckboxCellGroup;
