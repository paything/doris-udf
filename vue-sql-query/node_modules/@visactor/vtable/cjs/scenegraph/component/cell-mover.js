...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.CellMover = void 0;

const vrender_1 = require("./../../vrender"), get_cell_merge_1 = require("../utils/get-cell-merge");
...
class CellMover {
    constructor(table) {
        ...
        this.columnMoverLabel = (0, vrender_1.createSymbol)({
            visible: !1,
            pickable: !1,
            x: 0,
            y: 0,
    ...
    show(col, row, delta) {
        const cellLocation = this.table.getCellLocation(col, row), mergeInfo = (0, get_cell_merge_1.getCellMergeInfo)(this.table, col, row);
