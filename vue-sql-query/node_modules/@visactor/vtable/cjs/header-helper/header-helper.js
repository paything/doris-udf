...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.HeaderHelper = void 0;

const ts_types_1 = require("../ts-types"), registerIcons = __importStar(require("../icons")), helper_1 = require("../tools/helper"), MenuElement_1 = require("../components/menu/dom/logic/MenuElement"), ImageStyle_1 = require("./style/ImageStyle"), style_1 = require("./style"), CheckboxStyle_1 = require("./style/CheckboxStyle"), vutils_1 = require("@visactor/vutils");

class HeaderHelper {
    constructor(_table) {
        this._table = _table;
        const regedIcons = registerIcons.get();
        this.freezeIcon = regedIcons[ts_types_1.InternalIconName.freezeIconName], this.frozenIcon = regedIcons[ts_types_1.InternalIconName.frozenIconName], 
        this.frozenCurrentIcon = regedIcons[ts_types_1.InternalIconName.frozenCurrentIconName], 
        this.normalIcon = regedIcons[ts_types_1.InternalIconName.normalIconName], this.upIcon = regedIcons[ts_types_1.InternalIconName.upwardIconName], 
        this.downIcon = regedIcons[ts_types_1.InternalIconName.downwardIconName], this.dropDownAbsoluteIcon = regedIcons[ts_types_1.InternalIconName.dropdownIconName], 
    ...
    getIcons(col, row) {
        ...
        if (this._table.isPivotTable()) {
            ...
            if (states) if (Array.isArray(states)) for (let i = 0; i < states.length; i++) {
                ...
                if (stateRange && (0, helper_1.cellInRange)(range, stateRange.col, stateRange.row)) {
                    ({order: order} = state);
                    break;
                }
            } else {
                const stateRange = this._table._getHeaderCellBySortState(states);
                stateRange && (0, helper_1.cellInRange)(range, stateRange.col, stateRange.row) && ({order: order} = states);
            }
    ...
    getSortIcon(order, _table, col, row) {
        ...
        return headerC && (_showSort = "function" == typeof headerC.showSort ? headerC.showSort({
            ...
            row: row,
            table: this._table
        }) : headerC.showSort), !headerC || !1 === _showSort || !(0, vutils_1.isValid)(_showSort) && !headerC.sort || headerC.columns && headerC.columns.length > 0 ? null : icon;
    }
    getSortIconForPivotTable(order, _table, col, row) {
        ...
        if (headerC && (_showSort = "function" == typeof headerC.showSort ? headerC.showSort({
            ...
            row: row,
            table: this._table
        }) : headerC.showSort), !headerC || !1 === _showSort || !(0, vutils_1.isValid)(_showSort) && !headerC.sort || headerC.columns && headerC.columns.length > 0) return null;
        ...
        if (Array.isArray(dropDownMenu) && dropDownMenu.length || Array.isArray(globalDropDownMenu) && globalDropDownMenu.length && !(null === (_a = null == headerC ? void 0 : headerC.columns) || void 0 === _a ? void 0 : _a.length)) {
            ...
            for (let i = 0; i < menus.length; i++) {
                ...
                if ("object" == typeof menu && menu.children && menu.children.length) for (let j = 0; j < menu.children.length; j++) {
                    ...
                    if ((null === (_b = _table.stateManager.menu) || void 0 === _b ? void 0 : _b.dropDownMenuHighlight) && (0, 
                    MenuElement_1.isMenuHighlight)(_table, null === (_c = _table.stateManager.menu) || void 0 === _c ? void 0 : _c.dropDownMenuHighlight, "object" == typeof childItem ? null == childItem ? void 0 : childItem.menuKey : childItem, col, row, i)) {
            ...
            if (-1 !== highlightIndex) {
                ...
                menu.stateIcon && (menu.stateIcon.svg ? results.push({
                    ...
                    marginRight: 0,
                    funcType: ts_types_1.IconFuncTypeEnum.dropDownState,
                    interactive: !1
    ...
    getHierarchyIcon(col, row) {
        ...
        if (hierarchyState) {
            if (hierarchyState === ts_types_1.HierarchyState.expand) return this.expandIcon;
            if (hierarchyState === ts_types_1.HierarchyState.collapse) return this.collapseIcon;
        }
    }
    ...
    getStyleClass(headerType) {
        switch (headerType) {
          case "text":
          case "link":
            return style_1.TextHeaderStyle;
