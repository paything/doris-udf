...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.endResizeRow = exports.endResizeCol = exports.bindGesture = exports.bindTableGroupListener = void 0;

const vrender_1 = require("./../../vrender"), ts_types_1 = require("../../ts-types"), util_1 = require("../util"), TABLE_EVENT_TYPE_1 = require("../../core/TABLE_EVENT_TYPE"), vutils_1 = require("@visactor/vutils"), icon_1 = require("../../scenegraph/utils/icon"), helper_1 = require("../../tools/helper"), Rect_1 = require("../../tools/Rect"), get_cell_merge_1 = require("../../scenegraph/utils/get-cell-merge"), scroll_1 = require("../scroll"), helper_2 = require("../helper");
...
function bindTableGroupListener(eventManager) {
    ...
    table.scenegraph.tableGroup.addEventListener("pointermove", (e => {
        ...
        if (eventArgsSet.eventArgs && table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEMOVE_TABLE) && table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEMOVE_TABLE, {
        ...
        })), table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEENTER_CELL) && ("cell" !== (null == cellGoup ? void 0 : cellGoup.role) || !(0, 
        vutils_1.isValid)(cellGoup.col) || !(0, vutils_1.isValid)(cellGoup.row) || cellGoup.col === table.stateManager.hover.cellPos.col && cellGoup.row === table.stateManager.hover.cellPos.row || cellGoup.col === (null === (_m = table.stateManager.hover.cellPosContainHeader) || void 0 === _m ? void 0 : _m.col) && cellGoup.row === (null === (_o = table.stateManager.hover.cellPosContainHeader) || void 0 === _o ? void 0 : _o.row) || table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEENTER_CELL, {
            col: cellGoup.col,
            row: cellGoup.row,
            cellRange: table.getCellRangeRelativeRect({
                col: cellGoup.col,
        ...
        eventArgsSet.eventArgs && table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEMOVE_CELL)) {
            ...
            if (null === (_r = eventArgsSet.eventArgs) || void 0 === _r ? void 0 : _r.target) {
                const iconInfo = (0, icon_1.getIconAndPositionFromTarget)(null === (_s = eventArgsSet.eventArgs) || void 0 === _s ? void 0 : _s.target);
        ...
        var _a, _b;
        const eventArgsSet = (0, util_1.getCellEventArgsSet)(e), cellGoup = null === (_a = null == eventArgsSet ? void 0 : eventArgsSet.eventArgs) || void 0 === _a ? void 0 : _a.target;
        if (cellGoup && table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEOVER_CHART_SYMBOL) && "symbol" === cellGoup.type) {
        ...
        table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEENTER_TABLE) && table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEENTER_TABLE, {
            event: e.nativeEvent
        });
    })), table.scenegraph.tableGroup.addEventListener("pointerleave", (e => {
        stateManager.isResizeCol() || stateManager.isResizeRow() || stateManager.isMoveCol() || stateManager.isSelecting() || (stateManager.updateInteractionState(ts_types_1.InteractionState.default), 
        ...
        table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSELEAVE_CELL) && -1 !== table.stateManager.hover.cellPos.col && -1 !== table.stateManager.hover.cellPos.row && table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSELEAVE_CELL, {
            col: table.stateManager.hover.cellPos.col,
            row: table.stateManager.hover.cellPos.row,
            cellRange: table.getCellRangeRelativeRect({
                col: table.stateManager.hover.cellPos.col,
        ...
        (0, helper_1.getPromiseValue)(isCompleteEdit, (isCompleteEdit => {
            ...
            if (eventManager.downIcon = hitIcon, hitIcon && !1 !== hitIcon.attribute.interactive) hitIcon.attribute.funcType === ts_types_1.IconFuncTypeEnum.dragReorder && (stateManager.startMoveCol(eventArgsSet.eventArgs.col, eventArgsSet.eventArgs.row, eventArgsSet.abstractPos.x, eventArgsSet.abstractPos.y, null === (_k = null === (_j = eventArgsSet.eventArgs) || void 0 === _j ? void 0 : _j.event) || void 0 === _k ? void 0 : _k.nativeEvent), 
            stateManager.updateInteractionState(ts_types_1.InteractionState.grabing)); else {
                ...
                if ("touch" === e.pointerType) {
                    ...
                    }), 500), table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEENTER_CELL)) {
                        const cellGoup = e.path.find((node => "cell" === node.role));
                        "cell" !== (null == cellGoup ? void 0 : cellGoup.role) || !(0, vutils_1.isValid)(cellGoup.col) || !(0, 
                        vutils_1.isValid)(cellGoup.row) || cellGoup.col === table.stateManager.hover.cellPos.col && cellGoup.row === table.stateManager.hover.cellPos.row || cellGoup.col === (null === (_e = table.stateManager.hover.cellPosContainHeader) || void 0 === _e ? void 0 : _e.col) && cellGoup.row === (null === (_f = table.stateManager.hover.cellPosContainHeader) || void 0 === _f ? void 0 : _f.row) || table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEENTER_CELL, {
                            col: cellGoup.col,
                            row: cellGoup.row,
                            cellRange: table.getCellRangeRelativeRect({
                                col: cellGoup.col,
                    ...
                    if (eventManager.checkColumnMover(eventArgsSet)) return void stateManager.updateInteractionState(ts_types_1.InteractionState.grabing);
        ...
        if (0 === e.button) {
            if ("grabing" === stateManager.interactionState) {
                if (stateManager.updateInteractionState(ts_types_1.InteractionState.default), stateManager.isResizeCol()) endResizeCol(table); else if (stateManager.isResizeRow()) endResizeRow(table); else if (stateManager.isMoveCol()) {
                    ...
                    (0, helper_2.fireMoveColEventListeners)(table, endMoveColSuccess, e.nativeEvent);
                } else if (stateManager.isSelecting()) {
                    table.stateManager.endSelectCells(), table.stateManager.isFillHandle() && table.stateManager.endFillSelect();
                    const eventArgsSet = (0, util_1.getCellEventArgsSet)(e);
                    if (table.eventManager.isDraging && eventArgsSet.eventArgs && table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.DRAG_SELECT_END)) {
                        const cellsEvent = {
                            event: e.nativeEvent,
                            cells: [],
            ...
            } else stateManager.interactionState === ts_types_1.InteractionState.scrolling && stateManager.updateInteractionState(ts_types_1.InteractionState.default);
        ...
        const eventArgsSet = (0, util_1.getCellEventArgsSet)(e);
        if (!eventManager.isTouchMove && 0 === e.button && eventArgsSet.eventArgs && table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.CLICK_CELL)) {
        ...
        (0, helper_1.getPromiseValue)(isCompleteEdit, (isCompleteEdit => {
            ...
            if (eventManager.downIcon = hitIcon, "touch" === e.pointerType || hitIcon || eventManager.checkCellFillhandle(eventArgsSet) || stateManager.columnResize.resizing || !eventManager.checkColumnResize(eventArgsSet, !0)) ; else {
                ...
                if (!(null == eventArgs ? void 0 : eventArgs.targetCell)) {
                    table.getCellAt(eventArgsSet.abstractPos.x - table.theme.columnResize.resizeHotSpotSize / 2, eventArgsSet.abstractPos.y) && table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEDOWN_TABLE) && table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.MOUSEDOWN_TABLE, {
                        event: e.nativeEvent
                    });
                }
            }
        ...
        if (table.eventManager.isDraging || !target || !target.isDescendantsOf(table.scenegraph.stage) && target.stage !== target || target.isDescendantsOf(table.scenegraph.tableGroup)) table.eventManager.isDraging && stateManager.isSelecting() && stateManager.endSelectCells(); else {
            stateManager.updateInteractionState(ts_types_1.InteractionState.default), eventManager.dealTableHover();
        ...
        var _a, _b;
        const eventArgsSet = (0, util_1.getCellEventArgsSet)(e), {col: col, row: row, target: target} = eventArgsSet.eventArgs, cellInfo = table.getCellInfo(col, row), mergeRange = (0, 
        get_cell_merge_1.getCellMergeInfo)(table, col, row);
        if (mergeRange) for (let col = mergeRange.start.col; col <= mergeRange.end.col; col++) for (let row = mergeRange.start.row; row <= mergeRange.end.row; row++) {
        ...
        table.stateManager.setCheckedState(col, row, cellInfo.field, e.detail.checked), 
        table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.SWITCH_STATE_CHANGE, cellsEvent), 
        table.scenegraph.updateNextFrame();
        ...
        table.eventManager._enableTableScroll && (0, scroll_1.handleWhell)(e, stateManager));
    }));
}

function bindGesture(eventManager) {
    const table = eventManager.table;
    eventManager.gesture = new vrender_1.Gesture(table.scenegraph.tableGroup, {
        tap: {
            interval: 300
        }
...
function endResizeRow(table) {
    table.stateManager.endResizeRow(), table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.RESIZE_ROW_END, {
...
function dblclickHandler(e, table) {
    ...
    if (bounds && table.internalProps.focusControl.setFocusRect(new Rect_1.Rect(bounds.x1 + table.scrollLeft, bounds.y1 + table.scrollTop, bounds.x2 - bounds.x1, bounds.y2 - bounds.y1), value), 
...
exports.bindTableGroupListener = bindTableGroupListener, exports.bindGesture = bindGesture, 
exports.endResizeCol = endResizeCol, exports.endResizeRow = endResizeRow;
