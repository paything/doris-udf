...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindContainerDomListener = void 0;

const vutils_1 = require("@visactor/vutils"), ts_types_1 = require("../../ts-types"), TABLE_EVENT_TYPE_1 = require("../../core/TABLE_EVENT_TYPE"), scroll_1 = require("../scroll"), helper_1 = require("../../tools/helper"), pixel_ratio_1 = require("../../tools/pixel-ratio"), table_group_1 = require("./table-group"), is_cell_select_highlight_1 = require("../../state/select/is-cell-select-highlight"), helper_2 = require("../helper"), vrender_1 = require("./../../vrender");
...
function bindContainerDomListener(eventManager) {
    ...
    function handleKeydownListener(e) {
        var _a;
        if (table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.KEYDOWN)) {
            const cellsEvent = {
            ...
            table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.KEYDOWN, cellsEvent);
        }
    }
    handler.on(table.getElement(), "blur", (e => {
        ...
        if (table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.BEFORE_KEYDOWN, beforeKeydownEvent), 
        "a" === e.key && (e.ctrlKey || e.metaKey)) (null === (_b = table.keyboardOptions) || void 0 === _b ? void 0 : _b.selectAllOnCtrlA) && (e.preventDefault(), 
        eventManager.deelTableSelectAll()); else if (stateManager.select.cellPos.col >= 0 && stateManager.select.cellPos.row >= 0 && ("ArrowUp" === e.key || "ArrowDown" === e.key || "ArrowLeft" === e.key || "ArrowRight" === e.key)) {
            ...
            (0, is_cell_select_highlight_1.isCellDisableSelect)(table, targetCol, targetRow)) return;
        ...
        table.getElement().focus(); else if ("Enter" === e.key) {
            if (null === (_l = table.editorManager) || void 0 === _l ? void 0 : _l.editingEditor) {
                ...
                !0 === (null === (_m = table.options.keyboardOptions) || void 0 === _m ? void 0 : _m.moveFocusCellOnEnter)) {
                    ...
                    if ((0, is_cell_select_highlight_1.isCellDisableSelect)(table, targetCol, targetRow)) return;
            ...
            if ((null === (_u = null === (_t = table.options.keyboardOptions) || void 0 === _t ? void 0 : _t.moveFocusCellOnTab) || void 0 === _u || _u) && stateManager.select.cellPos.col >= 0 && stateManager.select.cellPos.row >= 0) {
                ...
                targetCol = stateManager.select.cellPos.col + 1), (0, is_cell_select_highlight_1.isCellDisableSelect)(table, targetCol, targetRow)) return;
        ...
        (0, vutils_1.isValid)(table.options.pixelRatio) || table.setPixelRatio((0, pixel_ratio_1.getPixelRatio)()), 
        e.windowSizeNotChange || table.resize());
    }));
    ...
    }), vrender_1.vglobal.addEventListener("pointerdown", globalPointerdownCallback);
    const globalPointerupCallback = e => {
        ...
        if (target !== table.canvas && (e => {
            ...
            }), 0), stateManager.isResizeCol()) (0, table_group_1.endResizeCol)(table); else if (stateManager.isResizeRow()) (0, 
            table_group_1.endResizeRow)(table); else if (stateManager.isMoveCol()) {
                const endMoveColSuccess = table.stateManager.endMoveCol();
                (0, helper_2.fireMoveColEventListeners)(table, endMoveColSuccess, e);
                ...
                if (table.stateManager.endSelectCells(), table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.DRAG_SELECT_END)) {
                    const cellsEvent = {
                        event: e,
                        cells: [],
                        col: lastCol,
        ...
        "grabing" === stateManager.interactionState && stateManager.isResizeCol()) (0, table_group_1.endResizeCol)(table); else if ("grabing" === stateManager.interactionState && stateManager.isResizeRow()) (0, 
        table_group_1.endResizeRow)(table); else if (stateManager.isMoveCol()) {
            const endMoveColSuccess = table.stateManager.endMoveCol();
            (0, helper_2.fireMoveColEventListeners)(table, endMoveColSuccess, e);
            ...
            const isCompleteEdit = null === (_a = table.editorManager) || void 0 === _a ? void 0 : _a.completeEdit(e);
            (0, helper_1.getPromiseValue)(isCompleteEdit, (isCompleteEdit => {
                !1 !== isCompleteEdit && (stateManager.updateInteractionState(ts_types_1.InteractionState.default), 
                eventManager.dealTableHover());
            }));
        }
    };
    ...
    }), vrender_1.vglobal.addEventListener("pointerup", globalPointerupCallback);
    const globalPointermoveCallback = e => {
        ...
        stateManager.interactionState === ts_types_1.InteractionState.grabing && (stateManager.isResizeCol() ? (eventManager.dealColumnResize(x, y), 
        table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.RESIZE_COLUMN) && table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.RESIZE_COLUMN, {
            col: table.stateManager.columnResize.col,
            colWidth: table.getColWidth(table.stateManager.columnResize.col)
        })) : stateManager.isResizeRow() && (eventManager.dealRowResize(x, y), table.hasListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.RESIZE_ROW) && table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.RESIZE_ROW, {
        ...
        if (eventManager._enableTableScroll && eventManager.isDraging && isSelecting && (null === (_e = table.stateManager.select.ranges) || void 0 === _e ? void 0 : _e.length) > 0) {
            ...
            if ((y > drawRange.bottom - bottomFrozenRowHeight || y < drawRange.top + topFrozenRowHeight) && canScrollY || (x > drawRange.right - rightFrozenColsWidth || x < drawRange.left + leftFrozenColsWidth) && canScrollX) {
                ...
                table.eventManager.inertiaScroll.setScrollHandle(((dx, dy) => {
                    ...
                    considerFrozenY = !0) : selectY = table.scrollTop + y), table.stateManager.updateInteractionState(ts_types_1.InteractionState.grabing);
                    ...
                    !(null === (_a = table.options.select) || void 0 === _a ? void 0 : _a.disableDragSelect) && (0, 
                    vutils_1.isValid)(targetCol) && (0, vutils_1.isValid)(targetRow) && table.stateManager.updateSelectPos(targetCol.col, targetRow.row, !1, !1, !1, !1);
                }));
    ...
    }), vrender_1.vglobal.addEventListener("pointermove", globalPointermoveCallback);
}

exports.bindContainerDomListener = bindContainerDomListener;
