...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindMediaClick = void 0;

const vutils_1 = require("@visactor/vutils"), TABLE_EVENT_TYPE_1 = require("../core/TABLE_EVENT_TYPE"), env_1 = require("../tools/env"), global_1 = require("../tools/global"), helper_1 = require("../tools/helper");

function bindMediaClick(table) {
    "browser" === env_1.Env.mode && table.on(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.CLICK_CELL, (e => {
        ...
        if ("link" === cellType) {
            let linkJump = (0, helper_1.getOrApply)(columnDefine.linkJump, {
                col: col,
                row: row,
                table: table,
                value: cellValue,
            ...
            let url, linkDetect = (0, helper_1.getOrApply)(columnDefine.linkDetect, {
                col: col,
                row: row,
                table: table,
                value: cellValue,
            ...
            if (linkDetect = !1 !== linkDetect, templateLink) {
                ...
                if ((0, vutils_1.isFunction)(templateLink)) url = templateLink(data, col, row, table); else {
                    const re = /\{\s*(\S+?)\s*\}/g;
                    url = templateLink.replace(re, ((matchs, key) => data[key]));
                }
            } else if (linkDetect) {
                if (!global_1.regUrl.test(cellValue)) return;
                url = cellValue;
            } else url = cellValue;
            if (!url) return;
