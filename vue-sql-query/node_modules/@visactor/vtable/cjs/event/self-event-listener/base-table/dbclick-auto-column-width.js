...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindDBClickAutoColumnWidthEvent = void 0;

const TABLE_EVENT_TYPE_1 = require("../../../core/TABLE_EVENT_TYPE"), util_1 = require("../../util");

function bindDBClickAutoColumnWidthEvent(table) {
    table.on(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.DBLCLICK_CELL, (e => {
        var _a, _b, _c;
        if (e.federatedEvent) {
            const eventArgsSet = (0, util_1.getCellEventArgsSet)(e.federatedEvent), resizeCol = table.scenegraph.getResizeColAt(eventArgsSet.abstractPos.x, eventArgsSet.abstractPos.y, null === (_a = eventArgsSet.eventArgs) || void 0 === _a ? void 0 : _a.targetCell), disableDblclickAutoResizeColWidth = null !== (_b = table.options.disableDblclickAutoResizeColWidth) && void 0 !== _b ? _b : null === (_c = table.options.resize) || void 0 === _c ? void 0 : _c.disableDblclickAutoResizeColWidth;
            if (table.eventManager.checkCellFillhandle(eventArgsSet)) table.fireListeners(TABLE_EVENT_TYPE_1.TABLE_EVENT_TYPE.DBLCLICK_FILL_HANDLE, {}); else if (table._canResizeColumn(resizeCol.col, resizeCol.row) && resizeCol.col >= 0 && !disableDblclickAutoResizeColWidth) {
...
exports.bindDBClickAutoColumnWidthEvent = bindDBClickAutoColumnWidthEvent;
