...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindHeaderCheckboxChange = exports.bindGroupTitleCheckboxChange = void 0;

const vutils_1 = require("@visactor/vutils"), checkbox_1 = require("../../../state/checkbox/checkbox"), ts_types_1 = require("../../../ts-types");
...
function bindGroupTitleCheckboxChange(table) {
    table.on("checkbox_state_change", (args => {
        ...
        if ((0, vutils_1.isNumber)(titleIndex) && (titleIndex = [ titleIndex ]), record.vtableMerge || (null === (_b = record.children) || void 0 === _b ? void 0 : _b.length)) if (checked) getHierarchyState(table, col, row) === ts_types_1.HierarchyState.collapse ? updateChildrenCheckboxState(!0, titleIndex, table) : setAllChildrenCheckboxState(!0, titleShowIndex, titleIndex, indexedData, table), 
        updateGroupTitleCheckboxState(titleShowIndex, titleIndex, indexedData, table); else {
            getHierarchyState(table, col, row) === ts_types_1.HierarchyState.collapse ? updateChildrenCheckboxState(!1, titleIndex, table) : setAllChildrenCheckboxState(!1, titleShowIndex, titleIndex, indexedData, table), 
...
function setAllChildrenCheckboxState(state, titleShowIndex, titleIndex, indexedData, table) {
    ...
    for (;(0, vutils_1.isArray)(indexedData[i]) && (null === (_a = indexedData[i]) || void 0 === _a ? void 0 : _a.length) > titleIndex.length; ) {
        const row = table.columnHeaderLevelCount + i;
        table.stateManager.setCheckedState(0, row, "_vtable_rowSeries_number", state), (0, 
        checkbox_1.setCellCheckboxStateByAttribute)(0, row, state, table), i++;
    }
}
...
function updateGroupTitleCheckboxState(titleShowIndex, titleIndex, indexedData, table) {
    ...
    if (parentLength > 0) {
        ...
        for (;parentLength > 0 && i >= 0; ) {
            if ((0, vutils_1.isArray)(indexedData[i]) && (null === (_a = indexedData[i]) || void 0 === _a ? void 0 : _a.length) === parentLength || 1 === parentLength && (0, 
            vutils_1.isNumber)(indexedData[i])) {
...
function updateParentCheckboxState(col, row, currentIndex, table) {
    const {checkedState: checkedState} = table.stateManager, key = currentIndex.toString(), currentIndexLength = (0, 
    vutils_1.isArray)(currentIndex) ? currentIndex.length : 1;
    let start = !1;
    ...
    (0, checkbox_1.setCellCheckboxStateByAttribute)(col, row, !0, table)) : allUnChecked ? (table.stateManager.setCheckedState(col, row, "_vtable_rowSeries_number", !1), 
    (0, checkbox_1.setCellCheckboxStateByAttribute)(col, row, !1, table)) : (table.stateManager.setCheckedState(col, row, "_vtable_rowSeries_number", "indeterminate"), 
    (0, checkbox_1.setCellCheckboxStateByAttribute)(col, row, "indeterminate", table));
}
...
exports.bindGroupTitleCheckboxChange = bindGroupTitleCheckboxChange, exports.bindHeaderCheckboxChange = bindHeaderCheckboxChange;
